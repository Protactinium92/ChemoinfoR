...
The functional programming is a paradigm of building computer program with a declarative type. In this case, the programs are constructed by applying and composing functions.  In R the `tibble` library (and other *tixxx*) allow this kind programation with the following construction `variable %>% function()`. The functional is a better way to write a comprehensive workflow:
